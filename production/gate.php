...
if (!(isset($_POST["id"]) && $gate = Gate::find_by_id($_POST["id"]))) {
    $gate = new Gate();
}
?>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($gate->id)) ? 'Add' : 'Edit'; ?> Cross Gate</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/gate_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $gate->id; ?>" />
                                <div class="form-group">
                                    <label>Gate Name</label>
                                    <input type="text" class="form-control" placeholder="Gate Name" id="txtName" name="name" value="<?php echo $gate->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($gate->id)) ? 'none' : 'initial'; ?>">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="gate.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
