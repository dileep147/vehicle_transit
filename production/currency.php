...
if (!(isset($_POST["id"]) && $currency = Currency::find_by_id($_POST["id"]))) {
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($currency->id)) ? 'Add' : 'Edit'; ?> Currency</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/currency_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $currency->id; ?>" />
                                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" id="txtName" name="name" value="<?php echo $currency->name; ?>" required="">
                                </div>
                                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                    <label>Symbol</label>
                                    <input type="text" class="form-control" placeholder="Symbol" id="txtName" name="symbol" value="<?php echo $currency->symbol; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($currency->id)) ? 'none' : 'initial'; ?>">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="currency.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
//        });
    ...
    $("#btnSave").click(function () {
        var id = <?php echo ($currency->id) ? 1 : 0; ?>;
