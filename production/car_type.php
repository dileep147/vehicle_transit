...
if (!(isset($_POST["id"]) && $type = CarType::find_by_id($_POST["id"]))) {
    $type = new CarType();
}
?>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($type->id)) ? 'Add' : 'Edit'; ?> Type</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/car_type_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $type->id; ?>" />
                                <div class="form-group">
                                    <label>Car Type</label>
                                    <input type="text" class="form-control" placeholder="Car Type" id="txtName" name="name" value="<?php echo $type->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($type->id)) ? 'none' : 'initial'; ?>">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="car_type.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
