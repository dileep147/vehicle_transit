...
if (!(isset($_POST["id"]) && $contracted =  Contracted::find_by_id($_POST["id"]))) {
    $contracted = new  Contracted();
}
?>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($contracted->id)) ? 'Add' : 'Edit'; ?>  How To Contract?</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/contracted_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $contracted->id; ?>" />

                                <div class="form-group">
                                    <label>How To Contract?</label>
                                    <input type="text" class="form-control" placeholder="How To Contract?" id="txtName" name="name" value="<?php echo $contracted->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($contracted->id)) ? 'none' : 'initial'; ?>">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="contracted.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
//        });
    ...
    $("#btnSave").click(function () {
        var id = <?php echo ($contracted->id) ? 1 : 0; ?>;
