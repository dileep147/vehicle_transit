...
if (!(isset($_POST["id"]) && $model = Model::find_by_id($_POST["id"]))) {
    $model = new Model();
}
?>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($model->id)) ? 'Add' : 'Edit'; ?> Model</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/model_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $model->id; ?>" />
                                <div class="form-group">
                                    <label>Model Name</label>
                                    <input type="text" class="form-control" placeholder="Model Name" id="txtName" name="name" value="<?php echo $model->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($model->id)) ? 'none' : 'initial'; ?>">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="model.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
